...
$movies = query("SELECT * FROM movie WHERE production_co_id=$id");
// var_dump($movies);
// die;
?>
<!doctype html>
    ...
    <main role="main" class="container-fluid bg-dark-light-ph">
        ...
        <div class="row">
            <div class="col-3 border-right border-dark">
                <img src="../img/productionCo/<?= $company['logo'] ?>" class="img-fluid" alt="Responsive image">

                <h5>Information</h5>
                <p class="text-sm-left">Name :<span style="color: #808080;"> <?= $company['name'] ?></span>
