...
$characters = query("SELECT * FROM movie_character WHERE movie_id='$id'");
        ...
        <div class="row">
            <div class="col-3 border-right border-dark">
                ...
                <p class="text-sm-left">Title :<span style="color: #808080;"> <?= $movie['title'] ?></span>
                    ...
                    <br>Director : <span style="color: #808080;"><a
                            href="detailPeople.php?id=<?= $director['people_id'] ?>"><?= $director['name'] ?></a></span>

                    <br>Language : <span style="color: #808080;"><?= $movie['language'] ?></span>

                    <br>Production company : <span style="color: #808080;"><a
                            href="detailCompany.php?id=<?= $company['production_co_id'] ?>"><?= $company['name'] ?></a></span>
            ...
            <div class="col-8 ml-3">
                ...
                <div class="row mt-3">
                    <div id="reviewer-score" class="bg-dark-yellow-ph p-2 mr-3 rounded">
                        <h1 class="text-center"><?= $movie['score'] ?></h1>
                        <p class="text-center">10 User Score</p>
                    </div>
                </div>
                ...
                <div class="row mt-1">
                    <iframe width="420" height="315" src=<?= $movie['trailer'] ?> class="mr-2">
                    </iframe>
                    <a href="https://www.amazon.com/s?k=<?= seoUrl($movie['title']) ?>&amp;i=movies-tv-intl-ship&amp;ref=nb_sb_noss?_encoding=UTF8&amp;camp=1789&amp;creative=9325&amp;linkCode=ur2&amp;tag=storypodca-20&amp;linkId=2P4S6EY6B462X4AR"
                        target="_blank" rel="noopener noreferrer" style="border:none;text-decoration:none"
                        class="align-self-center"><img src="https://www.niftybuttons.com/amazon/amazon-button7.png"></a>
                ...
                <table class="table table-hover bg-dark-light-ph">
                    <thead class="thead-dark">
                        <tr>
                            <th scope="col">Character photo</th>
                            <th scope="col" class="border-right">Character name</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="detailCharacter.php?id=<?= $character['character_id'] ?>">
                                    <img src="../img/character/<?= $character['photo'] ?>" alt="">
                                </a></td>
                            <td><a
                                    href="detailCharacter.php?id=<?= $character['character_id'] ?>"><?= $character['name'] ?></a>
                            </td>
                            <td>
                                <?php
                                    $peopleId = $character['people_id'];
                                    $actor = query("SELECT * FROM people WHERE people_id=$peopleId")[0]; ?>
                                <a href="detailPeople.php?id=<?= $character['people_id'] ?>"><?= $actor['name'] ?></a>
                            </td>
                        </tr>
                        <?php endforeach ?>
