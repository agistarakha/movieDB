...
$characters = query("SELECT * FROM movie_character WHERE people_id=$id");
$movies = query("SELECT * FROM movie WHERE director_id='$id'");
    ...
    <main role="main" class="container-fluid bg-dark-light-ph">
        ...
        <div class="row">
            <div class="col-3 border-right border-dark">
                <img src="../img/people/<?= $people['photo'] ?>" class="img-fluid" alt="Responsive image">
                ...
                <div class="row">
                    <table class="table table-hover bg-dark-light-ph">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" class="text-white"><?= $j ?></th>
                                ...
                                <td class="text-center"><a
                                        href="detailCharacter.php?id=<?= $character['character_id'] ?>"
                                        class="btn btn btn-secondary bg-dark-ph font-weight-bold">Detail</a></td>
                            </tr>
                            <?php $j++ ?>
                            <?php endforeach ?>
