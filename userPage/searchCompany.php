...
<body>
    ...
    <main role="main" class="container-fluid bg-dark-light-ph">
        <div class="row">
            <h1>Search Production company</h1>
        </div>
        <div class="row mb-3">
            <form action="" method="post">
                <label for="keyword">Search Production company</label><br>
                <input type="text" name="keyword" id="keyword" size="50" autofocus
                    placeholder="Search Production company by name" autocomplete="off">
            ...
            <table class="table table-hover bg-dark-light-ph">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="detailCompany.php?id=<?= $company['production_co_id'] ?>"><img
                                    src="../img/productionCo/<?= $company['logo'] ?>" alt=""></a></td>
                        <td><a href="detailCompany.php?id=<?= $company['production_co_id'] ?>" class="text-white">
                                Name : <?= $company['name'] ?>
                            </a></td>
                        <td class="text-center"><a href="detailCompany.php?id=<?= $company['production_co_id'] ?>"
